import { DashboardHeader, NscDrsShipperApplicationList } from '../../components';

const NscDrsFreightRateRequest = () => {
  return (
    <main className="flex-1 p-6 space-y-6 md:h-screen md:overflow-y-auto">
      ...
      <div className="bg-white rounded-2xl shadow-md p-6 w-full">
        ...
        <div className="h-8"/>
      <NscDrsShipperApplicationList  />
    </main>
  )
}

export default NscDrsFreightRateRequest;
