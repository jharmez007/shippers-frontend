...
const AnnualKPIAverage = ({ indicators = [], terminals = [], data = [] }) => {
  ...
  return (
    <div className="bg-white rounded-xl shadow p-4 space-y-4 overflow-x-auto">
      <h3 className="text-lg font-semibold text-gray-800">Annual KPI Averages</h3>
...
export default AnnualKPIAverage;
