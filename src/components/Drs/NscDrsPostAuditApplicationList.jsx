...
import { CustomTab, NscDrsPostAuditApplicationDetailModal } from ".."; 
...
const NscDrsPostAuditApplicationList = () => {
      ...
      {filtered.length === 0 ? (
        ...
        <>
          ...
          {/* Modal */}
            ...
            <NscDrsPostAuditApplicationDetailModal
              isOpen={open}
...
export default NscDrsPostAuditApplicationList;
