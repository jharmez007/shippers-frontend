...
import { CustomTab, NscDrsChartererApplicationDetailModal } from ".."; 
...
const NscDrsChartererApplicationList = () => {
      ...
      {filtered.length === 0 ? (
        ...
        <>
          ...
          {/* Modal */}
            ...
            <NscDrsChartererApplicationDetailModal
              isOpen={open}
...
export default NscDrsChartererApplicationList;
