...
import { nscDrsMainLinks, nscDrsAccountLinks } from "../../constants/dummy";
      ...
      <>
        ...
        >
          ...
          <nav className="space-y-4">
            {nscDrsMainLinks.map(({ name, icon: Icon, path }) => (
              <NavLink
                key={name}
                to={path}
                onClick={() => setIsOpen(false)}
          ...
          <div>
            ...
            <div className="space-y-4">
              {nscDrsAccountLinks.map(({ name, icon: Icon, path }) => (
                <NavLink
                  key={name}
                  to={path}
                  onClick={() => setIsOpen(false)}
