...
import { MoreHorizontal, Eye, Upload, ShieldCheck, Clock, RotateCcw } from "lucide-react";
...
const actionIcons = {
  ...
  "Mark as Contested": <ShieldCheck className="w-4 h-4 mr-2 text-blue-500" />, // Blue for contested
