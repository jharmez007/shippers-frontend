...
import { nscMainLinks, nscAccountLinks } from "../../constants/dummy";
      ...
      <>
        ...
        >
          ...
          <nav className="space-y-4">
            {nscMainLinks.map(({ name, icon: Icon, path }) => (
              <NavLink
                key={name}
                to={path}
                onClick={() => setIsOpen(false)}
          ...
          <div>
            ...
            <div className="space-y-4">
              {nscAccountLinks.map(({ name, icon: Icon, path }) => (
                <NavLink
                  key={name}
                  to={path}
                  onClick={() => setIsOpen(false)}
