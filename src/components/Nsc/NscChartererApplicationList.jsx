...
import { CustomTab, NscChartererApplicationDetailModal } from ".."; 
...
const NscChartererApplicationList = () => {
      ...
      {filtered.length === 0 ? (
        ...
        <>
          ...
          {/* Modal */}
            ...
            <NscChartererApplicationDetailModal
              isOpen={open}
...
export default NscChartererApplicationList;
