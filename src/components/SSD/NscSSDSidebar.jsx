...
import { ssdMainLinks, ssdAccountLinks } from "../../constants/dummy";
      ...
      <>
        ...
        >
          ...
          <nav className="space-y-4">
            {ssdMainLinks.map(({ name, icon: Icon, path }) => (
              <NavLink
                key={name}
                to={path}
                onClick={() => setIsOpen(false)}
          ...
          <div>
            ...
            <div className="space-y-4">
              {ssdAccountLinks.map(({ name, icon: Icon, path }) => (
                <NavLink
                  key={name}
                  to={path}
                  onClick={() => setIsOpen(false)}
