...
import { CustomTab, NscMandTHeadPostAuditApplicationDetailModal } from ".."; 
...
const NscMandTHeadPostAuditApplicationList = () => {
      ...
      {filtered.length === 0 ? (
        ...
        <>
          ...
          {/* Modal */}
            ...
            <NscMandTHeadPostAuditApplicationDetailModal
              isOpen={open}
...
export default NscMandTHeadPostAuditApplicationList;
