...
import { CustomTab, NscMandTHeadChartererApplicationDetailModal } from ".."; 
...
const mockApplications = [
  { id: 1, status: "Pending", amount: "$234,898.00", date: "5th January 2024", title: "Charter Request A", shipper: "Vessel A" },
  { id: 2, status: "Approved", amount: "$234,898.00", date: "5th February 2025", title: "Charter Request B", shipper: "Vessel B" },
  { id: 3, status: "Rejected", amount: "$234,898.00", date: "5th March 2025", title: "Charter Request C", shipper: "Vessel C" },
  { id: 4, status: "Pending", amount: "$234,898.00", date: "5th April 2025", title: "Charter Request D", shipper: "Vessel D" },
  { id: 5, status: "Rejected", amount: "$234,898.00", date: "5th May 2025", title: "Charter Request E", shipper: "Vessel E" },
  // ... more data
];
...
const NscMandTHeadChartererApplicationList = () => {
      ...
      {filtered.length === 0 ? (
        ...
        <>
          ...
          {/* Modal */}
            ...
            <NscMandTHeadChartererApplicationDetailModal
              isOpen={open}
...
export default NscMandTHeadChartererApplicationList;
