...
import { nscMandTHeadMainLinks, nscMandTHeadAccountLinks } from "../../constants/dummy";
import { images } from "../../constants";


const NscMandTHeadSidebar = () => {
      ...
      <>
        ...
        >
          ...
          <nav className="space-y-4">
            {nscMandTHeadMainLinks.map(({ name, icon: Icon, path }) => (
              <NavLink
                key={name}
                to={path}
                onClick={() => setIsOpen(false)}
          ...
          <div>
            ...
            <div className="space-y-4">
              {nscMandTHeadAccountLinks.map(({ name, icon: Icon, path }) => (
                <NavLink
                  key={name}
                  to={path}
                  onClick={() => setIsOpen(false)}
...
export default NscMandTHeadSidebar;
